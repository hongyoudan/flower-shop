  ...
  <div class="mall-purchase">
    ...
    <div class="product-info">
      <div class="product-info-content container">
        <div class="img left">
          <el-image :src="productInfo.productUrl" class="leftImg"></el-image>
          <!-- 鼠标层罩 -->
        ...
        <div v-show="rShow" class="right">
          <el-image :src="productInfo.productUrl" :style="r_img" class="rightImg"></el-image>
        </div>
        <div class="product-con">
          ...
          <div class="price-info">
            ...
            <span v-else>当前库存 {{productInfo.productStock}}</span>
            <el-divider direction="vertical"></el-divider>
    ...
    <el-dialog title="收货地址" class="address-dialog" width="460px"  :visible.sync="addressFormVisible">
